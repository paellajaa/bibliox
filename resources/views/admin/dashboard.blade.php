...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <div class="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-600/5 transition-all duration-300">
        <div class="flex justify-between items-start">
            ...
            <div class="w-12 h-12 bg-cyan-50 rounded-2xl flex items-center justify-center text-2xl">👥</div>
        </div>
...
<div class="mt-12 bg-gradient-to-br from-blue-600 to-blue-800 p-12 rounded-[40px] shadow-2xl shadow-blue-600/20 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl">
        <h1 class="text-4xl font-black text-white leading-tight italic">Sistem Perpustakaan<br><span class="text-cyan-300 underline decoration-white/30">Generasi Digital</span></h1>
        <p class="mt-6 text-blue-100 font-medium leading-relaxed opacity-80">Halo Admin! Kelola data buku dan pantau aktivitas anggota BIBLIOX dengan antarmuka modern yang lebih bersih dan efisien.</p>
    </div>
</div>
@endsection